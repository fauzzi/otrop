...
public class EspressoActivity extends ToolbarActivity {
...
//                mCountText.setText("Count: " + childCount);
  ...
  private ArrayList loadData() {
    ...
    arrayList.add(new Possum("Splash", R.drawable.es_splash));
    arrayList.add(new Possum("Landing Menu", R.drawable.es_landing));
    arrayList.add(new Possum("Broadcast", R.drawable.es_landing_broadcast));
    arrayList.add(new Possum("Gift Menu", R.drawable.es_gift_menu));
    arrayList.add(new Possum("Payment", R.drawable.es_wallet_select_payment_mode));
    return arrayList;
  }
