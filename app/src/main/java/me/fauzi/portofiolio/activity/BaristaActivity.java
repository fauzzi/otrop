...
public class BaristaActivity extends ToolbarActivity {
  ...
  protected void onViewCreated() {
    toolbar.setTitle("63Espresso Barista");
    initViewPager();
  }
...
//                mCountText.setText("Count: " + childCount);
  ...
  private ArrayList loadData() {
    ...
    arrayList.add(new Possum("Login", R.drawable.barista_login));
    arrayList.add(new Possum("Landing Menu", R.drawable.barista_landing));
    arrayList.add(new Possum("Broadcast", R.drawable.barista_3b_broadcast_2));
    arrayList.add(new Possum("Purchase", R.drawable.barista_purchase_3));
    arrayList.add(new Possum("Credit", R.drawable.barista_notenough_credit_1));
    return arrayList;
  }
