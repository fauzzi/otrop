...
public class BuddyAdapter extends PagerAdapter {
  ...
  public BuddyAdapter(Context context, ArrayList<Item> xRaySummaries, OnItemClickListener listener) {
...
//    Picasso.with(context).load(item.getImage()).resize(600, 200).centerCrop().into(mPicture);
